...
![OpenClaw floating window demo](docs/images/openclaw-floating-window-demo.png)
...
- Provides a floating OpenClaw window on top of active pages, keeping the agent workspace available while browsing, watching videos, or reading feeds.
...
- Side-panel and floating workflow: keep the agent close to the active browsing session without switching apps.
...
![OpenClaw 悬浮窗口演示图](docs/images/openclaw-floating-window-demo.png)
...
- 提供覆盖在当前网页上的 OpenClaw 悬浮窗口，刷视频、读信息流或浏览页面时也能保持 Agent 工作区随手可用。
...
- 侧边栏与悬浮窗口工作流：让智能体贴近当前浏览场景，不需要频繁切换应用。
